...
<head>
    ...
    <title>新增付款商品 - 管理後台 - DISINFO SCANNER</title>
            ...
            <main class="flex-1 p-6">
                <div class="max-w-3xl mx-auto">
                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <span class="ml-1 text-gray-500">新增商品</span>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                        <h1 class="text-3xl font-bold text-gray-900">新增付款商品</h1>
                        <p class="mt-1 text-sm text-gray-600">建立新的 Portaly 付款商品</p>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm">
                        <form action="{{ route('admin.payment-products.store') }}" method="POST" class="p-6 space-y-6">
                            @csrf
                            ...
                            <div>
                                ...
                                <input type="text" id="portaly_product_id" name="portaly_product_id" value="{{ old('portaly_product_id') }}"
                            ...
                            <div>
                                ...
                                <input type="url" id="portaly_url" name="portaly_url" value="{{ old('portaly_url') }}"
                            ...
                            <div>
                                ...
                                <select id="action_type" name="action_type"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    <option value="extend_premium" {{ old('action_type', 'extend_premium') === 'extend_premium' ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <select id="status" name="status"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    <option value="active" {{ old('status', 'active') === 'active' ? 'selected' : '' }}>啟用中</option>
