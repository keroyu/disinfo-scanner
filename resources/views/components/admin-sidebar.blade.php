...
<aside class="w-64 bg-gray-900 text-white flex-shrink-0" x-data="{ currentPath: window.location.pathname }">
    <div class="p-6">
        ...
        <nav class="space-y-2">
            ...
            <!-- Point Settings (013-point-system) -->
            <a href="{{ route('admin.points.settings') }}"
               :class="currentPath.startsWith('/admin/points') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white'"
               class="flex items-center px-4 py-3 rounded-lg transition">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Payment Products (015-membership-payment T065) -->
            <a href="{{ route('admin.payment-products.index') }}"
               :class="currentPath.startsWith('/admin/payment-products') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white'"
               class="flex items-center px-4 py-3 rounded-lg transition">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Payment Settings (015-membership-payment T066) -->
            <a href="{{ route('admin.payment-settings.index') }}"
               :class="currentPath.startsWith('/admin/payment-settings') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white'"
               class="flex items-center px-4 py-3 rounded-lg transition">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Payment Logs (015-membership-payment T067) -->
            <a href="{{ route('admin.payment-logs.index') }}"
               :class="currentPath.startsWith('/admin/payment-logs') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white'"
               class="flex items-center px-4 py-3 rounded-lg transition">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
