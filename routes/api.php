...
// FR-030: Regular Members and above can use U-API import, visitors cannot
Route::prefix('uapi')->middleware(['web', 'auth'])->group(function () {
...
// Official YouTube API Import (Premium Members and above only)
